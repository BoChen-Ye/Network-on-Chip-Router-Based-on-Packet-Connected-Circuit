...
HD_PWD='D:/BaiduNetdiskDownload/NoC-PCC/pcc_circle/circle_noc_pcc/circle_noc_pcc.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pcc24_ring.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pcc24_ring.tcl -notrace
