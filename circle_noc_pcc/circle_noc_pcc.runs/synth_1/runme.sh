...
HD_PWD='D:/BaiduNetdiskDownload/NoC-PCC/pcc_circle/circle_noc_pcc/circle_noc_pcc.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pcc24_ring.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pcc24_ring.tcl
